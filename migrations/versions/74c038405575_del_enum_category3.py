...
Revision ID: 74c038405575
Revises: 27e3f0e99a5b
Create Date: 2023-11-30 15:38:55.415580
...
revision = '74c038405575'
down_revision = '27e3f0e99a5b'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('expenses_category', sa.Enum('buyer', 'capital', 'fixed', 'interest', 'investments', 'invoice_job', 'old_debt', 'settlements', 'variable', 'other', name='expensestype'), nullable=False),
    ...
    sa.Column('document_type', sa.Enum('payment', 'invoice', 'changes', 'undefined', name='document_types'), nullable=True),
